...
void ExportTlsDir()
{
  ...
  boost::python::class_<TlsDirWrap, boost::python::bases<
    ...
    .def("SetStartAddressOfRawData", &TlsDirWrap::SetStartAddressOfRawData)
    .def("GetEndAddressOfRawData", &TlsDirWrap::GetEndAddressOfRawData)
    .def("SetEndAddressOfRawData", &TlsDirWrap::SetEndAddressOfRawData)
    .def("GetAddressOfIndex", &TlsDirWrap::GetAddressOfIndex)
    .def("SetAddressOfIndex", &TlsDirWrap::SetAddressOfIndex)
    .def("GetAddressOfCallBacks", &TlsDirWrap::GetAddressOfCallBacks)
    .def("SetAddressOfCallBacks", &TlsDirWrap::SetAddressOfCallBacks)
    .def("GetSizeOfZeroFill", &TlsDirWrap::GetSizeOfZeroFill)
    .def("SetSizeOfZeroFill", &TlsDirWrap::SetSizeOfZeroFill)
    .def("GetCharacteristics", &TlsDirWrap::GetCharacteristics)
    .def("SetCharacteristics", &TlsDirWrap::SetCharacteristics)
