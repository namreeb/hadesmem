...
void TestImportDirList()
{
    ...
    for (auto const& mod : modules)
    {
        ...
        for (auto const& d : import_dirs)
        {
            ...
            test_import_dir.SetTimeDateStamp(
                test_import_dir.GetTimeDateStamp());
            test_import_dir.SetForwarderChain(
                test_import_dir.GetForwarderChain());
            ...
            auto const imp_dir_raw_new = 
                hadesmem::Read<IMAGE_IMPORT_DESCRIPTOR>(
                process, 
                test_import_dir.GetBase());
            ...
            for (auto const& t : import_thunks)
            {
                ...
                auto const imp_thunk_raw = hadesmem::Read<IMAGE_THUNK_DATA>(
                    process,
                    test_thunk.GetBase());
                ...
                auto const imp_thunk_raw_new = 
                    hadesmem::Read<IMAGE_THUNK_DATA>(
