...
// Thanks to Apoc for providing his DM to me

namespace Hades_DomainManager
{
        ...
        public OnyxDomain()
        {
            try
            {
                ...
                DomainManager.CurrentAssemblyLoader.LoadAndRun(
                    Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "Hades-DotNetTest.exe"));
            }
            catch (Exception e)
            {
