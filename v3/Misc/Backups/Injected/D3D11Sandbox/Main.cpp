...
HRESULT InitDevice()
{
    ...
    hr = CompileShaderFromMemory(Tutorial02Fx, sizeof(Tutorial02Fx), "Tutorial02.fx", "VS", "vs_4_0", &pVSBlob );
    if( FAILED( hr ) )
    {
        MessageBox( NULL,
    ...
    hr = CompileShaderFromMemory(Tutorial02Fx, sizeof(Tutorial02Fx), "Tutorial02.fx", "PS", "ps_4_0", &pPSBlob );
    if( FAILED( hr ) )
    {
        MessageBox( NULL,
                    L"The FX file cannot be compiled.  Please run this executable from the directory that contains the FX file.", L"Error", MB_OK );
