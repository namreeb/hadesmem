...
namespace hadesmem
{
    ...
    inline DWORD SuspendThread(Thread const& thread)
    {
        HADESMEM_DETAIL_TRACE_FORMAT_A(
            "Suspending thread with ID 0n%lu.",
            thread.GetId());
    ...
    public:
        ...
        SuspendedThread& operator=(SuspendedThread&& other) 
    ...
    public:
        ...
        SuspendedProcess& operator=(SuspendedProcess&& other) 
            HADESMEM_DETAIL_NOEXCEPT
        {
            threads_ = std::move(other.threads_);
