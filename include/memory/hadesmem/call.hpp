...
namespace hadesmem
{
    ...
    namespace detail
    {
        ...
        // type.
        HADESMEM_DETAIL_STATIC_ASSERT(
            std::is_pod<detail::CallResultRemote>::value);
    ...
    private:
        ...
        template <typename T>
        T GetReturnValueIntOrFloatImpl(
            std::true_type, 
            std::false_type,
        ...
        {
            HADESMEM_DETAIL_STATIC_ASSERT(std::is_pointer<T>::value);
            return GetReturnValuePtrImpl<T>(std::integral_constant<
                bool,
        ...
        DWORD_PTR GetReturnValueIntPtr() const HADESMEM_DETAIL_NOEXCEPT
        {
            return static_cast<DWORD_PTR>(
                result_.return_i64 & static_cast<DWORD_PTR>(-1));
        }
    ...
    namespace detail
    {
        ...
        {
            return CallResult<T>(
                result.GetReturnValue<T>(), 
                result.GetLastError());
        }

        template <>
        inline CallResult<void> CallResultRawToCallResult(
            CallResultRaw const& result) HADESMEM_DETAIL_NOEXCEPT
        {
    ...
    namespace detail
    {
        ...
        public:
            ...
            void operator()(float arg) HADESMEM_DETAIL_NOEXCEPT
            {
                ...
                case 4:
                    assembler_->mov(
                        AsmJit::dword_ptr(AsmJit::rsp, scratch_offs), 
                        arg_conv);
                    break;
                default:
                    break;
                ...
                default:
                    assembler_->mov(
                        AsmJit::dword_ptr(AsmJit::rsp, (cur_arg_ - 1) * 8),
                        arg_conv);
                    break;
                }
            ...
            void operator()(double arg) HADESMEM_DETAIL_NOEXCEPT
            {
                ...
                DWORD const arg_low = static_cast<DWORD>(
                    arg_conv & 0xFFFFFFFFUL);
                ...
                case 4:
                    assembler_->mov(
                        ...
                        arg_low);
                    assembler_->mov(
                        AsmJit::dword_ptr(AsmJit::rsp, scratch_offs + 4),
                        arg_high);
                    break;
                default:
                    break;
                ...
                case 1:
                    assembler_->movsd(
                        AsmJit::xmm0, 
                        AsmJit::qword_ptr(AsmJit::rsp, scratch_offs));
                    break;
                case 2:
                    assembler_->movsd(
                        AsmJit::xmm1, 
        ...
        inline void GenerateCallCode32(
            AsmJit::X86Assembler* assembler,
            ...
            PVOID return_values_remote)
        {
                ...
                assembler->mov(
                    AsmJit::eax, 
                    AsmJit::uimm(is_debugger_present));
                    ...
                    ++i)
                {
                    ...
                    assembler->mov(
                        AsmJit::eax, 
                        reinterpret_cast<sysint_t>(address));
                    assembler->call(AsmJit::eax);
                    ...
                    assembler->mov(
                        AsmJit::ecx, 
                        AsmJit::uimm(current_return_value_remote +
                        offsetof(detail::CallResultRemote, return_i64)));
                    assembler->mov(
                        AsmJit::dword_ptr(AsmJit::ecx), 
                        AsmJit::eax);
                    assembler->mov(
                        AsmJit::dword_ptr(AsmJit::ecx, 4), 
                        AsmJit::edx);
                    ...
                    if (call_conv == CallConv::kDefault 
                        || call_conv == CallConv::kCdecl)
                    {
                        assembler->add(
                            AsmJit::esp, 
                            AsmJit::uimm(num_args * sizeof(void*)));
                    }
                }
            ...
            PVOID return_values_remote)
        {
                ...
                std::size_t const num_addresses = 
                    std::distance(addresses_beg, addresses_end);
                auto const max_args_list = std::max_element(
                    args_full_beg,
                    args_full_beg + num_addresses, 
                    ContainerSizeComparer());
                    ...
                    [&]()
                {
                    ...
                    std::size_t stack_offs_tmp = 
                        (std::max)(ghost_size, max_num_args * 0x8);
                    ...
                    ++i)
                {
                    ...
                    HADESMEM_DETAIL_ASSERT(
                        *call_convs_beg == CallConv::kDefault ||
                    ...
                    assembler->mov(AsmJit::rcx, current_return_value_remote +
                        offsetof(detail::CallResultRemote, return_i64));
                    assembler->mov(
                        AsmJit::qword_ptr(AsmJit::rcx), 
                        AsmJit::rax);

                    assembler->mov(
                        AsmJit::rcx, 
                        current_return_value_remote +
                        offsetof(detail::CallResultRemote, return_float));
                    assembler->movss(
                        AsmJit::dword_ptr(AsmJit::rcx), 
                        AsmJit::xmm0);
            ...
            PVOID return_values_remote)
        {
                ...
                auto const is_debugger_present = reinterpret_cast<DWORD_PTR>(
                    ...
                    kernel32, 
                    "IsDebuggerPresent"));
                auto const debug_break = reinterpret_cast<DWORD_PTR>(
                    FindProcedure(
                    process, 
                    kernel32, 
                    "DebugBreak"));
...
#error "[HadesMem] Unsupported architecture."
        ...
        ResultsOutputIterator results)
    {
        ...
        auto const num_addresses_signed = std::distance(
            addresses_beg,
            addresses_end);
