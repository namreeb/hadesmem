...
#define HADESMEM_DETAIL_NO_FINAL
#endif // #if defined(HADESMEM_MSVC)
...
#if defined(HADESMEM_DETAIL_NO_FINAL)
#define HADESMEM_DETAIL_FINAL 
#else // if defined(HADESMEM_DETAIL_NO_FINAL)
#define HADESMEM_DETAIL_FINAL final
#endif // if defined(HADESMEM_DETAIL_NO_FINAL)
