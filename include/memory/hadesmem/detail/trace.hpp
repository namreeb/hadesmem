...
#define HADESMEM_DETAIL_TRACE_NOISY_FORMAT_A(format, ...) HADESMEM_DETAIL_TRACE_FORMAT_A(format, __VA_ARGS__)

#define HADESMEM_DETAIL_TRACE_NOISY_FORMAT_W(format, ...) HADESMEM_DETAIL_TRACE_FORMAT_W(format, __VA_ARGS__)
