...
namespace hadesmem
{
    ...
    namespace detail
    {
        ...
        inline hadesmem::detail::Optional<MODULEENTRY32> Module32First(
            HANDLE snap)
        {
        ...
        inline hadesmem::detail::Optional<MODULEENTRY32> Module32Next(
            HANDLE snap)
        {
        ...
        inline hadesmem::detail::Optional<PROCESSENTRY32> Process32First(
            HANDLE snap)
        {
        ...
        inline hadesmem::detail::Optional<PROCESSENTRY32> Process32Next(
            HANDLE snap)
        {
        ...
        inline hadesmem::detail::Optional<THREADENTRY32> Thread32First(
            HANDLE snap)
        {
        ...
        inline hadesmem::detail::Optional<THREADENTRY32> Thread32Next(
            HANDLE snap)
        {
