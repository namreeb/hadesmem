...
namespace hadesmem
{
    ...
    namespace detail
    {
        ...
        struct IsDefaultConstructible
        {
            ...
            // TODO: Update to use std::is_default_constructible trait when 
            // available in libstdc++. In the meantime it should be safe to 
            // mark every type as default constructible as even if it isn't, 
            // it will result in a compile-time error anyway.
