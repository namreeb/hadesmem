...
namespace hadesmem
{
    ...
    class ImportDirIterator : public std::iterator<
    ...
    public:
        ...
        ImportDirIterator(ImportDirIterator const& other) 
        ...
        ImportDirIterator& operator++()
        {
            try
            {
                ...
                bool const has_ilt_or_iat = 
                    impl_->import_dir_->GetOriginalFirstThunk() 
        ...
        bool operator==(ImportDirIterator const& other) const 
            HADESMEM_DETAIL_NOEXCEPT
        {
