...
namespace hadesmem
{
    ...
    class ExportIterator : public std::iterator<
    ...
    public:
        ...
        ExportIterator& operator=(ExportIterator const& other) 
        ...
        ExportIterator& operator=(ExportIterator&& other) 
            HADESMEM_DETAIL_NOEXCEPT
        {
            impl_ = std::move(other.impl_);
        ...
        bool operator==(ExportIterator const& other) const 
            HADESMEM_DETAIL_NOEXCEPT
        {
