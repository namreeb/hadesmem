...
namespace hadesmem
{
    ...
    public:
        ...
        WORD GetMagic() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_magic));
        }
        ...
        WORD GetBytesOnLastPage() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_cblp));
        }
        ...
        WORD GetPagesInFile() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_cp));
        }
        ...
        WORD GetRelocations() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_crlc));
        }
        ...
        WORD GetSizeOfHeaderInParagraphs() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_cparhdr));
        }
        ...
        WORD GetMinExtraParagraphs() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_minalloc));
        }
        ...
        WORD GetMaxExtraParagraphs() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_maxalloc));
        }
        ...
        WORD GetInitialSS() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_ss));
        }
        ...
        WORD GetInitialSP() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_sp));
        }
        ...
        WORD GetChecksum() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_csum));
        }
        ...
        WORD GetInitialIP() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_ip));
        }
        ...
        WORD GetInitialCS() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_cs));
        }
        ...
        WORD GetRelocTableFileAddr() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_lfarlc));
        }
        ...
        WORD GetOverlayNum() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_ovno));
        }
        ...
        std::array<WORD, 4> GetReservedWords1() const
        {
            return Read<WORD, 4>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_res));
        }
        ...
        WORD GetOEMID() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_oemid));
        }
        ...
        WORD GetOEMInfo() const
        {
            return Read<WORD>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_oeminfo));
        }
        ...
        std::array<WORD, 10> GetReservedWords2() const
        {
            return Read<WORD, 10>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_res2));
        }
        ...
        LONG GetNewHeaderOffset() const
        {
            return Read<LONG>(
                *process_, 
                base_ + offsetof(IMAGE_DOS_HEADER, e_lfanew));
        }
