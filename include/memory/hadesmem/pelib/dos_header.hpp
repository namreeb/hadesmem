...
public:
  ...
  {
    return Read<WORD>(*process_, base_ + offsetof(IMAGE_DOS_HEADER, e_cparhdr));
  }
  ...
  {
    return Read<WORD>(*process_, base_ + offsetof(IMAGE_DOS_HEADER, e_lfarlc));
  }
  ...
  {
    return Read<WORD, 4>(*process_, base_ + offsetof(IMAGE_DOS_HEADER, e_res));
  }
  ...
  {
    return Read<WORD>(*process_, base_ + offsetof(IMAGE_DOS_HEADER, e_oeminfo));
  }

  std::array<WORD, 10> GetReservedWords2() const
  {
    return Read<WORD, 10>(*process_,
                          base_ + offsetof(IMAGE_DOS_HEADER, e_res2));
  }

  LONG GetNewHeaderOffset() const
  {
    return Read<LONG>(*process_, base_ + offsetof(IMAGE_DOS_HEADER, e_lfanew));
  }
  ...
  {
    Write(
      *process_, base_ + offsetof(IMAGE_DOS_HEADER, e_res), reserved_words_1);
  }
  ...
  {
    Write(
      *process_, base_ + offsetof(IMAGE_DOS_HEADER, e_res2), reserved_words_2);
  }
