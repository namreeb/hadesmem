...
namespace hadesmem
{
        ...
        DWORD rva)
    {
        ...
        if (type == PeFileType::Data)
        {
            ...
            IMAGE_DOS_HEADER dos_header = Read<IMAGE_DOS_HEADER>(
                process, 
                base);
            ...
            IMAGE_NT_HEADERS nt_headers = Read<IMAGE_NT_HEADERS>(
                process,
                ptr_nt_headers);
            ...
            for (WORD i = 0; i < num_sections; ++i)
            {
                ...
                DWORD const virtual_end = virtual_beg + 
                ...
                section_header = Read<IMAGE_SECTION_HEADER>(
                    process,
                    ++ptr_section_header);
            }
